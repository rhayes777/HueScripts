...
colourDict = {"red": colourForHueDegrees(0), "orange": colourForHueDegrees(40), "yellow": colourForHueDegrees(80),
              "sky": colourForHueDegrees(200), "purple": colourForHueDegrees(280), "pink": colourForHueDegrees(300),
              "green": colourForHueDegrees(130), "blue": colourForHueDegrees(240),
              "turquoise": colourForHueDegrees(180), "red2": colourForHueDegrees(360), "light": whiteColour(),
              "white": whiteColour()}
